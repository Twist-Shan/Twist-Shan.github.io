...
<section class="hero shell">
  <div class="hero-copy reveal">
    ...
    <div class="about-copy">
      ...
      <p>My research interests span the statistical foundations, optimization, and mechanistic interpretability of <strong>Modern Machine Learning</strong>, with a focus on Deep Learning (DL), Reinforcement Learning (RL), and Generative AI, including Large Language Models (LLMs) and Diffusion Language Models (DLMs).</p>
